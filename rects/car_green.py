class CarGreen():
    ...
    def update(self):
        ...
        if self.surface == self.settings.car_green_surface or self.settings.boat_green_surface:
            if self.nitro_reload < self.nitro_timer:
                ...
                self.nitro_reload = 0
                self.nitro_timer = 0
        if self.surface == self.settings.car_green_long_surface or self.settings.boat_green_long_surface:
            if self.nitro_reload < self.nitro_timer:
